...
<div class="container py-5">
    ...
    <div class="row align-items-center g-5">
        ...
        <div class="col-lg-6">
            ...
            <p>
                <strong>JobAdAssam.com</strong> is an educational and career information platform dedicated to helping
            ...
            <p>
                Our mission is to make reliable information easily accessible by publishing timely updates on government
                jobs, private jobs, examination results, admit cards, answer keys, scholarships, educational news, and
                competitive exam study materials.
            </p>

            <p>
                We strive to present information in a simple, accurate, and user-friendly format so visitors can quickly
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="text-muted mb-0">
                        Latest Government Jobs, Private Jobs, Recruitment Notifications, Walk-in Interviews, and Career
                        Opportunities.
                    </p>
        ...
        <div class="col-md-4">
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="text-muted mb-0">
                        Results, Admit Cards, Answer Keys, Scholarships, Admissions, Exam Notifications, and Educational
                        Updates.
                    </p>
        ...
        <div class="col-md-4">
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="text-muted mb-0">
                        Download free and premium PDF notes, previous year question papers, guides, and competitive exam
                        resources.
                    </p>
    ...
    <div class="card border-0 bg-light rounded-4 mt-5">
        ...
        <div class="card-body p-4">
            ...
            <p>
                ...
                career-related information. We continuously work to provide accurate, updated, and easy-to-understand
    ...
    <div class="card border-0 bg-light rounded-4 mt-4">
        ...
        <div class="card-body p-4">
            ...
            <p class="mb-0">
                ...
                organization, recruitment board, educational institution, or examination authority. While we make every
